...
- **Output Folder**: {project-root}/documents
- **Planning Artifacts**: {project-root}/documents/planning-artifacts
- **Implementation Artifacts**: {project-root}/documents/implementation-artifacts

...
- Load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-04-decisions.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-04-decisions.md` to begin making specific architectural decisions.

...
- Load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-08-complete.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-08-complete.md` to complete the workflow and provide implementation guidance.

...
- Load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-07-validation.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-07-validation.md` to validate architectural coherence and completeness.

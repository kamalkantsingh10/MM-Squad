...
- Load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-03-starter.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/mm/workflows/architect/create-architecture/steps/step-03-starter.md` to evaluate starter template options.
